...
class Category < ActiveRecord::Base
    ...
    validates :selection_process_id , numericality: { only_integer: true , greater_than: 0 , less_than: 9_223_372_036_854_775_808 , message: 'debe ser entero y mayor que 0' }
