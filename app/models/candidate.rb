# encoding: utf-8
# Modelo: para los candidatos de cada categoría.
class Candidate < ActiveRecord::Base
   ...
   validates :category_id , numericality: { only_integer: true , greater_than: 0 , less_than: 9_223_372_036_854_775_808 , message: 'debe ser entero y mayor que 0' }

   # Nombre Unico.
   validates :name , uniqueness: { scope: :category_id , message: 'ese nombre ya está siendo utilizado.' }

   # Controlar cantidad de Candidatos por Categoria.
