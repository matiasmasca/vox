...
candidates = [
    ...
    {:name => "Comida con hierro" , :bios => "Colocar comida con pelotitas de hierro, luego usar un íman grande para atrapar a la presa.", :category_id => "5", url_image: "jpg"},
    {:name => "Tunel falso" , :bios => "Pintar un tunel falso sobre una pared, y luego redirigir las lineas del trafico hacia él.", :category_id => "5", url_image: "jpg"},
    ...
    {:name => "ACME Missile-Bombs" , :bios => "Cohete marca ACME con volante y alerones", :category_id => "2", url_image: "jpg"},
